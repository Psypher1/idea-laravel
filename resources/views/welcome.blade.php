...
<body
    ...
    <header class="w-full lg:max-w-4xl max-w-87.35 text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
    ...
    <div
        ...
        <main class="flex max-w-87.35 w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
            ...
            <div
                class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-335/364 lg:aspect-auto w-full lg:w-108.5 shrink-0 overflow-hidden">
                {{-- Laravel Logo --}}
                ...
                <svg class="w-109.5 max-w-none relative -mt-[6.6rem] -ml-8 lg:ml-0 [--stroke-color:#1B1B18] dark:[--stroke-color:#FF750F]"
                    ...
                    <g
                        class="mix-blend-hard-light transition-all delay-400 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-19.5 text-[#F3BEC7] dark:text-[#4B0600]">
